# -*- coding: utf-8 -*-
# Generated by Django 1.11.3 on 2017-10-23 14:06
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True, null=True)),
                ('modified', models.DateTimeField(auto_now=True, null=True)),
                ('country', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='web.Countries')),
            ],
            options={
                'db_table': 'states',
            },
        ...
        migrations.AddField(
            model_name='myuser',
            name='state',
            field=models.ForeignKey(blank=True, default=1, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='state', to='web.States'),
        ),
        migrations.AddField(
            model_name='myuser',
