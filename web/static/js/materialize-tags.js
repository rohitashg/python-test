    ...
    TagsMaterialize.prototype = {
        ...
        */
        add : function (item, dontPushVal, options)
        {
            ...
            /* make email changed */
            if (validateEmail(self.options.itemValue(item))) {
            ...
            // add a tag element
            var $tag = $('<span class="' + htmlEncode(tagClass) + (itemTitle !== null ? ('" title="' + itemTitle) : '') + '">' + htmlEncode(itemText) + '<i class="material-icons remove_chip" data-role="remove">close</i></span>'+'<input type="hidden" name="tag" value = "'+itemText+'">');
